...
const Footer = () => {
  return (
    <div className="h-screen w-full flex bg-zinc-700 rounded-tr-3xl  rounded-tl-3xl overflow-hidden">
      <div className="w-1/2  p-10  flex justify-between flex-col   ">
        <div className="heading">
          <h1 className='text-[7vw] font-["Neue_Montreal"]   leading-none font-extrabold text-white'>
            EYE-
          </h1>
          <h1 className='text-[7vw] leading-none font-extrabold font-["Neue_Montreal"]'>
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2  pt-10 bg-zinc-700">
        <h1 className='text-[5.5vw] font-["Neue_Montreal"]  leading-none  tracking-tight font-extrabold text-white'>
          PRESENTATIONS
        </h1>
        ...
        <div className="dets">
          {["S:", "Instagram", "Behance", "Facebook", "LinkedIn"].map(
            ...
            ${index !== 0 && "border-b w-content"}     flex-col ${
                  index == 0 && "my-8"
                }`}
              >
                {items}
       ...
       {/* second dets */}
       <div className="controller flex justify-between p-">
           
       <div className="dets">
          {["L:", "202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map(
            (items, index) => (
              <a
                key={index}
                className={`flex  w-fit
            ${index !== 0 && "border-b w-content"}  ${index == 2 && "mb-8"}   flex-col ${
                  index == 0 && "my-8"
                }`}
              >
                {items}
        ...
        <div className="dets mr-10">
          {["L:", "Home", "Services", "Our Work", "About Us","Insights","Contact us"].map(
            (items, index) => (
              <a
                key={index}
                className={`flex  w-fit
